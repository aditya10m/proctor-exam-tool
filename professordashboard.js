...
name: name, exam_link: exam_link, date_time_start: date_time_start, duration: duration, exam_code: exam_code, prof_email: props.prof_email, })
.then(function (response) {
console.log(response);
swal("Exam has been created. Your exam code has been copied to your clipboard, pleaseshareitwiththe students.");
})
...
var result = '';
var characters = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789';var charactersLength = characters.length;
var length = 5;
for ( var i = 0; i < length; i++ ) {
    ...
    You can create a new exam and see the results of previous exams. </p>
    </h4>
    <button
    style={{
    ...
    <button
    style={{
    width: "200px", borderRadius: "3px", letterSpacing: "1.5px", marginLeft:"10px", marginTop: "1rem" }}
    ...
    <br/>
    <br/>
    <LogsTable exam_code={exam_code_search} prof_email={props.prof_email}/><Dialog open={examDialogOpen} onClose={closeExamDialog} aria-labelledby="form-dialog-title"repositionOnUpdate={false}
    style={{ padding: '10px 10px 10px 10px' }}>
    <DialogTitle id="form-dialog-title">Create Exam</DialogTitle>
    <DialogContent margin="20px" style={{ padding: "30px" }}>
    <DialogContentText>
    Enter details for the exam. Press Generate to generate the examcode and shareit withthestudents.</DialogContentText>
<TextField
autoFocus
padding="10px" margin="dense" variant="standard"
id="name"
label="Exam Name"
type="text"
fullWidth
...
/>
<TextField
id="examLink" name="examLink"
label="Exam Link" margin="dense" variant="standard" value={exam_link}
...
label="DateTimePicker" value={date_time_start}
margin="dense" variant="standard" onChange={(newValue) => {
...
label="Exam duration (minutes)" margin="dense" variant="standard" value={duration}
...
/>
<TextField
id="exam_code" name="exam_code"
label="Exam Code" margin="dense"
18
variant="standard" value={exam_code}
disabled={true}
